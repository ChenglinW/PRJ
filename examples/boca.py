...
class BOCA(EvaluationComponent, SelectionEncoder):
    """
    ...
    def __init__(self, model = 1,
        ...
        SelectionEncoder.__init__(self, *args, **kwargs)
    ...
    def tuning_flags(self):
        ...
        wandb.init(
            ...
            name= f'BOCA {self.exe_cmd} Iterations: {self.total_iters} Number of flags: {len(self.flags)}',
            config={
